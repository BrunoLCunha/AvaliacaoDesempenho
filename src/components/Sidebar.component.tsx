  ...
  return (
    <>
      <Modal show={modalVisible} onHide={() => setModalVisible(false)}>
        <Modal.Header>
          <Modal.Title>
            Tem certeza que deseja ir para o dashboard de funcionários?
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          Suas respostas não serão salvas até que o relatório seja gerado!
        </Modal.Body>
        <Modal.Footer>
          <Button
            onClick={() => {
        ...
        >
          ...
          <div>
            <ul className="mt-3">
              <li
                style={
                  page === "dashboard" ? { backgroundColor: "#66aeff" } : {}
                }
              ...
              {setSurveyIndex && (
                <>
                  <li
                    style={
                      page === "avaliacao" ? { backgroundColor: "#66aeff" } : {}
                    }
                  ...
                  <li style={{ marginTop: "-2px" }}>
                    <S.CustomNav
                      ...
                      appearance="subtle"
                      reversed
                      activeKey={surveyIndex}
                      onSelect={setSurveyIndex}
                    >
                      <Nav.Item eventKey={0}>Desempenho</Nav.Item>
                      <Nav.Item eventKey={1}>Comportamento</Nav.Item>
                      <Nav.Item eventKey={2}>Habilidades sociais...</Nav.Item>
                    </S.CustomNav>
                  </li>
                </>
              )}
