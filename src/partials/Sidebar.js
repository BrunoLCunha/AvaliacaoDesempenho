  ...
  return (
    <div className="lg:w-64">
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink exact to="/" className="block">
            <div className="flex flex-grow">
              ...
              <h1 className="text-2xl uppercase text-gray-500 font-semibold pl-3" style={{color:"white", verticalAlign: "middle"}}>TITULO</h1>
            </div>
          </NavLink>
        </div>
        ...
        {/* Links */}
        <div>
          <h3 className="text-xs uppercase text-gray-500 font-semibold pl-3" style={{color:"white"}}>Pages</h3>
          <ul className="mt-3">
            {/* Dashboard */}
